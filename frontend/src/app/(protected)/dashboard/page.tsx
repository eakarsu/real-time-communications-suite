...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Real Time Communications Dashboard"
      subtitle="One merged real time communications view for Conversations, Channels, Agents, Queues, Routing, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared real time communications jobs into one surface. Conversations, Channels, Agents, Queues, Routing, Transcripts, documents, audit, and AI are presented as platform features.</div>
