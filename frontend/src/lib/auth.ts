export const AUTH_COOKIE = 'real_time_communications_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@real-time-comms.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@real-time-comms.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@real-time-comms.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
