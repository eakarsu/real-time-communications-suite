...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Conversations Packet', type: 'Conversations', owner: 'Communications Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Channels Review Bundle', type: 'Channels', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Agents Evidence Set', type: 'Agents', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
