...
const entitySeeds = [
  ['conversations', 'Conversations Records', 'Conversations priority queue', 'Open', 'Conversations exception list', 'Communications Lead', '$0'],
  ['channels', 'Channels Records', 'Channels priority queue', 'Review', 'Channels exception list', 'Communications Lead', '$0'],
  ['agents', 'Agents Records', 'Agents priority queue', 'Action needed', 'Agents exception list', 'Communications Lead', '$0'],
  ['queues', 'Queues Records', 'Queues priority queue', 'Open', 'Queues exception list', 'Communications Lead', '$0'],
  ['routing', 'Routing Records', 'Routing priority queue', 'Review', 'Routing exception list', 'Operations Lead', '$0'],
  ['transcripts', 'Transcripts Records', 'Transcripts priority queue', 'Action needed', 'Transcripts exception list', 'Operations Lead', '$0'],
  ['sentiment', 'Sentiment Records', 'Sentiment priority queue', 'Open', 'Sentiment exception list', 'Operations Lead', '$0'],
  ['escalations', 'Escalations Records', 'Escalations priority queue', 'Review', 'Escalations exception list', 'Operations Lead', '$0'],
  ['slas', 'SLAs Records', 'SLAs priority queue', 'Action needed', 'SLAs exception list', 'Governance Lead', '$0'],
  ['integrations', 'Integrations Records', 'Integrations priority queue', 'Open', 'Integrations exception list', 'Governance Lead', '$0'],
  ['quality', 'Quality Records', 'Quality priority queue', 'Review', 'Quality exception list', 'Intelligence Layer Lead', '$0'],
