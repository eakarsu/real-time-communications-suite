...
const featureSeeds = [
  ['conversations', 'Conversations', 'Conversations operating queue', 'Communications Lead', 'Review and assign next action'],
  ['channels', 'Channels', 'Channels operating queue', 'Communications Lead', 'Review and assign next action'],
  ['agents', 'Agents', 'Agents operating queue', 'Communications Lead', 'Review and assign next action'],
  ['queues', 'Queues', 'Queues operating queue', 'Communications Lead', 'Review and assign next action'],
  ['routing', 'Routing', 'Routing operating queue', 'Operations Lead', 'Review and assign next action'],
  ['transcripts', 'Transcripts', 'Transcripts operating queue', 'Operations Lead', 'Review and assign next action'],
  ['sentiment', 'Sentiment', 'Sentiment operating queue', 'Operations Lead', 'Review and assign next action'],
  ['escalations', 'Escalations', 'Escalations operating queue', 'Operations Lead', 'Review and assign next action'],
  ['slas', 'SLAs', 'SLAs operating queue', 'Governance Lead', 'Review and assign next action'],
  ['integrations', 'Integrations', 'Integrations operating queue', 'Governance Lead', 'Review and assign next action'],
  ['quality', 'Quality', 'Quality operating queue', 'Intelligence Layer Lead', 'Review and assign next action'],
