...
const seed: NotificationItem[] = [
  { id: 'note-1', title: 'Conversations alert', detail: 'Conversations queue needs review.', read: false },
  { id: 'note-2', title: 'Channels approval due', detail: 'Channels exception list needs approval.', read: false },
  { id: 'note-3', title: 'Agents updated', detail: 'Agents operating queue was refreshed.', read: true },
];
