...
PORT="${PORT:-4700}"
DB_NAME="${PGDATABASE:-real_time_communications_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Real Time Communications Suite"
echo "======================================="
echo
...
echo "Starting real time communications suite frontend on http://localhost:$PORT"
echo "Login: admin@real-time-comms.local / admin123"
